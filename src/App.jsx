    ...
    <main id="canvas" className="fondo w-screen h-screen bg-no-repeat bg-cover flex items-center justify-center bg-center ">
      {
        !valueSi ? (
          <div className="p-5">
            <h1 className="text-white font-bold text-5xl text-center">¿Puedo ser tu San Valentin?</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-5 items-center">
              ...
              >
                ...
                <span hidden>{document.title = Object.keys(randomValor).length === 0 ? "¿Puedo ser tu San Valentin?" : randomValor.description}</span>
              </button>
            </div>
          </div>
        ) : (
